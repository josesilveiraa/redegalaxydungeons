package net.fancyful;

import static net.fancyful.TextualComponent.rawText;
...
import net.fancyful.ArrayWrapper;
import net.fancyful.Reflection;
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	public FancyMessage(final TextualComponent firstPartText) {
		...
		if(nmsPacketPlayOutChatConstructor == null){
			try {
				nmsPacketPlayOutChatConstructor = net.fancyful.Reflection.getNMSClass("PacketPlayOutChat").getDeclaredConstructor(net.fancyful.Reflection.getNMSClass("IChatBaseComponent"));
	...
	public FancyMessage achievementTooltip(final Achievement which) {
		try {
			Object achievement = net.fancyful.Reflection.getMethod(net.fancyful.Reflection.getOBCClass("CraftStatistic"), "getNMSAchievement", Achievement.class).invoke(null, which);
			return achievementTooltip((String) net.fancyful.Reflection.getField(net.fancyful.Reflection.getNMSClass("Achievement"), "name").get(achievement));
	...
	public FancyMessage statisticTooltip(final Statistic which) {
		...
		try {
			Object statistic = net.fancyful.Reflection.getMethod(net.fancyful.Reflection.getOBCClass("CraftStatistic"), "getNMSStatistic", Statistic.class).invoke(null, which);
			return achievementTooltip((String) net.fancyful.Reflection.getField(net.fancyful.Reflection.getNMSClass("Statistic"), "name").get(statistic));
		} catch (IllegalAccessException e) {
                        Bukkit.getLogger().log(Level.WARNING, "Could not access method.", e);
			return this;
		} catch (IllegalArgumentException e) {
	...
	public FancyMessage statisticTooltip(final Statistic which, Material item) {
		...
		try {
			Object statistic = net.fancyful.Reflection.getMethod(net.fancyful.Reflection.getOBCClass("CraftStatistic"), "getMaterialStatistic", Statistic.class, Material.class).invoke(null, which, item);
			return achievementTooltip((String) net.fancyful.Reflection.getField(net.fancyful.Reflection.getNMSClass("Statistic"), "name").get(statistic));
		} catch (IllegalAccessException e) {
                        Bukkit.getLogger().log(Level.WARNING, "Could not access method.", e);
			return this;
	...
	public FancyMessage statisticTooltip(final Statistic which, EntityType entity) {
		...
		try {
			Object statistic = net.fancyful.Reflection.getMethod(net.fancyful.Reflection.getOBCClass("CraftStatistic"), "getEntityStatistic", Statistic.class, EntityType.class).invoke(null, which, entity);
			return achievementTooltip((String) net.fancyful.Reflection.getField(net.fancyful.Reflection.getNMSClass("Statistic"), "name").get(statistic));
		} catch (IllegalAccessException e) {
                        Bukkit.getLogger().log(Level.WARNING, "Could not access method.", e);
			return this;
	...
	public FancyMessage itemTooltip(final ItemStack itemStack) {
		try {
			Object nmsItem = net.fancyful.Reflection.getMethod(net.fancyful.Reflection.getOBCClass("inventory.CraftItemStack"), "asNMSCopy", ItemStack.class).invoke(null, itemStack);
			return itemTooltip(net.fancyful.Reflection.getMethod(net.fancyful.Reflection.getNMSClass("ItemStack"), "save", net.fancyful.Reflection.getNMSClass("NBTTagCompound")).invoke(nmsItem, net.fancyful.Reflection.getNMSClass("NBTTagCompound").newInstance()).toString());
		} catch (Exception e) {
			e.printStackTrace();
			return this;
		}
	...
	*/
	...
	public void send(Player player){
        ...
        private void send(CommandSender sender, String jsonString){
                ...
                try {
			Object handle = net.fancyful.Reflection.getHandle(player);
			Object connection = net.fancyful.Reflection.getField(handle.getClass(), "playerConnection").get(handle);
			net.fancyful.Reflection.getMethod(connection.getClass(), "sendPacket", net.fancyful.Reflection.getNMSClass("Packet")).invoke(connection, createChatPacket(jsonString));
		} catch (IllegalArgumentException e) {
                        Bukkit.getLogger().log(Level.WARNING, "Argument could not be passed.", e);
		} catch (IllegalAccessException e) {
                        Bukkit.getLogger().log(Level.WARNING, "Could not access method.", e);
	...
	private Object createChatPacket(String json) throws IllegalArgumentException, IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
		if(nmsChatSerializerGsonInstance == null){
			...
			String version = net.fancyful.Reflection.getVersion();
			...
			if (majorVersion < 1.8 || (majorVersion == 1.8 && lesserVersion == 1)) {
				chatSerializerClazz = net.fancyful.Reflection.getNMSClass("ChatSerializer");
			} else {
				chatSerializerClazz = net.fancyful.Reflection.getNMSClass("IChatBaseComponent$ChatSerializer");
			}
		...
		Object serializedChatComponent = fromJsonMethod.invoke(nmsChatSerializerGsonInstance, json, net.fancyful.Reflection.getNMSClass("IChatBaseComponent"));
